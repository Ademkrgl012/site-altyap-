...
const IDler = {
  ...
  botSecret: "wiSbeRKIXOHxDI3L-JvX6aYCTMfobRR-",
  ...
  sahipRolü: "813875678100455425",
  adminRolü: "813890887494533120",
  kodPaylaşımcıRolü: "836387535088255018",
  boosterRolü: "",
...
client.on("ready", () => {
  const listener = app.listen(process.env.PORT, function() {
    client.user.setActivity(`Adem Reyzz Code`, { type:"WATCHING" })
